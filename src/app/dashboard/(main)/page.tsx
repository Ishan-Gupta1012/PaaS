...
import { Plus, Copy, RefreshCw, CheckCircle2, Check, Lightbulb, Monitor, Tablet, Smartphone, UserCircle, Sparkles, User, Terminal, Briefcase, GraduationCap, ShieldCheck, Share2, ArrowRight, Globe, Rocket } from 'lucide-react';
...
export default function Dashboard() {
  ...
  return (
    <>
      <div className="flex-1 p-lg md:p-xl space-y-xl max-w-container-max mx-auto w-full">
          ...
          <section className="space-y-lg">
            ...
            <div className="flex overflow-x-auto gap-lg pb-md no-scrollbar snap-x">
              ...
              <div className="min-w-[320px] bg-surface-container-lowest rounded-xl border border-outline-variant shadow-sm overflow-hidden snap-start group">
                <Link href="/templates/software-engineer" className="aspect-[16/9] w-full relative overflow-hidden bg-neutral-900 group">
                  <img className="w-full h-full object-cover blur-[2px] group-hover:blur-0 group-hover:scale-110 group-hover:rotate-1 transition-all duration-700 ease-out" src="https://i.postimg.cc/cLBz4Hd5/Screenshot-2026-07-26-at-5-35-09-PM.png" alt="Developer Pro template" />
